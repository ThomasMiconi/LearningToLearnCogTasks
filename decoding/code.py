...
# NBTRIALSLOSS = 100              # Evolutionary loss is evaluated over the last 100 trials of each block
# NBTRIALS =  150 + NBTRIALSLOSS  # Total number of trials per block
...
EVALW = True
if EVALW:
    # NBTRIALS =  NBTRIALS   #  more "burn-in" trials? doesn't seem to change anything
    NBGEN = 1
    NBTASKSPERGEN = 1
    BS = 500
    MUTATIONSIZE = 0
